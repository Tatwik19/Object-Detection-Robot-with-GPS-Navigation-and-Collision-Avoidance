...
class Processor():
    def __init__(self, model,cls_nums):
        ...
        self.output_shapes = [
            (1, 3, 80, 80, self.output_filter),#80,80
            (1, 3, 40, 40, self.output_filter),#40,40
            (1, 3, 20, 20, self.output_filter)#20,20
        ]
